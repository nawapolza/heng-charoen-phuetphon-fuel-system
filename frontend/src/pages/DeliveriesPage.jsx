  ...
  return (
    <div className="page-shell">
      <div className="card-clean overflow-hidden">
        <div className="bg-gradient-to-r from-slate-950 via-emerald-950 to-emerald-700 p-5 text-white md:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <h1 className="text-2xl font-black tracking-tight md:text-3xl">รายการงานน้ำมัน</h1>
              <p className="mt-2 max-w-3xl text-sm font-semibold leading-6 text-emerald-100">ค้นหาใบสรุปย้อนหลังแบบอ่านง่าย</p>
            </div>
