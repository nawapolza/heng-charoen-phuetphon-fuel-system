      ...
      <div className="heng-login-shell">
        <section className="heng-login-story">
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-black uppercase tracking-[.22em] text-sky-300">HENG CHAROEN PHUETPHON</p>
            ...
            <p className="mt-5 max-w-xl text-base font-semibold leading-8 text-blue-100/80">บันทึกน้ำมัน รถ คนขับ สต๊อก และรายการย้อนหลังในหน้าจอเดียว รองรับทั้งโทรศัพท์ แท็บเล็ต และคอมพิวเตอร์</p>
          </div>
        ...
        <section className="heng-login-form-panel">
          <div className="mx-auto w-full max-w-md">
            <div className="mb-8">
              <div className="mb-5 flex h-16 w-16 items-center justify-center rounded-[1.4rem] bg-blue-50 ring-1 ring-blue-100 md:hidden">
                <img src="/logo-heng.png" alt="เฮงเจริญพืชผล" className="h-14 w-14 object-contain" />
              </div>
            ...
            <div className="mt-6 rounded-2xl border border-blue-100 bg-blue-50/70 p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-black text-blue-950">พร้อมใช้งานบนทุกขนาดหน้าจอ</p>
                  <p className="mt-1 text-xs font-bold leading-5 text-blue-800/70">ระบบจะแสดงเฉพาะเมนูที่บัญชีของคุณได้รับอนุญาต</p>
                </div>
              </div>
            </div>
          </div>
