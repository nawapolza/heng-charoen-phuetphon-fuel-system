...
export default function VehiclesPage() {
  ...
  return (
    <div className="page-shell">
      <div className="rounded-[2rem] bg-gradient-to-br from-slate-950 via-emerald-950 to-emerald-700 p-5 text-white shadow-xl shadow-emerald-950/20 md:p-6">
        <h1 className="text-2xl font-black md:text-3xl">รถ / คนขับรถ</h1>
        <p className="mt-2 max-w-2xl text-sm font-semibold leading-6 text-emerald-100">หน้านี้เห็นเฉพาะเจ้าของกิจการ ใช้จัดการทะเบียนรถ เบอร์รถ คนขับ และผูกกับพนักงาน เพื่อให้ Dashboard รวมข้อมูลถูกต้อง</p>
      </div>
        ...
        {vehicles.map((vehicle) => (
          <div key={vehicle.id} className="card p-5">
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="rounded-3xl bg-emerald-50 p-3 text-emerald-700"><Car size={22} /></div>
            </div>
