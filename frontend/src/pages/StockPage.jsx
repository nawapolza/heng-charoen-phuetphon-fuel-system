  ...
  return (
    <div className="page-shell">
      <div>
        ...
        <p className="page-subtitle">ระบบจะหักยอดจากงานน้ำมันอัตโนมัติ พร้อมบันทึกประวัติการเติมและการปรับสต๊อกเพื่อตรวจสอบย้อนหลัง</p>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-[1fr_.8fr]">
        <form onSubmit={submitAdd} className="card overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-600 to-amber-500 p-5 text-white">
            <h2 className="flex items-center gap-2 text-xl font-black"><PackagePlus size={22} /> เติมน้ำมันเข้าระบบ</h2>
            <p className="mt-1 text-sm font-bold text-emerald-50">ดีเซล / น้ำมันเครื่อง / แอดบลู</p>
          </div>
...
function StockFilePicker({ file, setFile }) {
  ...
  return (
    <div className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm md:col-span-2">
      ...
      <div className="mt-3 rounded-2xl border border-dashed border-emerald-200 bg-emerald-50/40 p-4 text-center">
        <input
          className="block w-full cursor-pointer text-sm font-bold text-slate-600 file:mr-3 file:rounded-xl file:border-0 file:bg-emerald-600 file:px-4 file:py-2 file:text-sm file:font-black file:text-white"
          type="file"
